import type { RoomGenerationInput } from "@/lib/roomGenerationTypes";

/**
 * Frontend-side mock payload mirrors backend mock data.
 * This single source is passed to both room-shell and per-item generation requests.
 */
export const ROOM_GENERATION_MOCK: RoomGenerationInput = {
  roomStructure: {
    roomId: "room-402",
